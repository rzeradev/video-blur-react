...
// Suppress MediaPipe WASM debug logs
if (typeof window !== 'undefined') {
    const originalWarn = console.warn;
    const originalLog = console.log;
    const suppressPatterns = [
        'vision_wasm', 'OpenGL', 'GL version', 'WebGL', 'Graph ',
        'gl_context', 'segmentation_postprocessor', 'Successfully destroyed',
        'I0', 'W0', // MediaPipe log prefixes
    ];
